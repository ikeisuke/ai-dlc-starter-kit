...
**次のアクション**: このファイル（setup-prompt.md）と同じディレクトリにある `setup-cycle.md` を読み込み、処理を継続してください。ユーザーの操作を待たずに自動で読み込むこと。
...
**次のアクション**: ユーザーが続行を承認した場合、`setup-cycle.md` を自動で読み込み、処理を継続してください。ユーザーの操作を待たずに自動で読み込むこと。
