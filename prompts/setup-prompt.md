...
| # | ソース | 宛先 | 内容 |
|---|--------|------|------|
| 1 | `[スターターキットパス]/prompts/package/prompts/` | `skills/aidlc/steps/` | フェーズプロンプト |
| 2 | `[スターターキットパス]/prompts/package/templates/` | `skills/aidlc/templates/` | ドキュメントテンプレート |
