...
if ! git -C "$AIDLC_PROJECT_ROOT" rev-parse --show-toplevel >/dev/null 2>&1 || [ ! -d "$AIDLC_PROJECT_ROOT/.aidlc" ]; then
...
# 定数
OLD_BACKLOG="${AIDLC_CYCLES}/backlog.md"
NEW_BACKLOG_DIR="${AIDLC_CYCLES}/backlog"
