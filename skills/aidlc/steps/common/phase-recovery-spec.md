...
- **判定条件**: `history/operations.md` に「PR Ready 化」記録あり（= サブステップ 7.8 完了）
...
- **判定条件**: `history/operations.md` に「PR マージ」記録あり（= サブステップ 7.13 完了）
...
| `operations.release_done` | `operations.03-release` | `steps/operations/03-release.md` | `history/operations.md` の「PR Ready 化」記録 |
| `operations.completion_done` | `operations.04-completion` | `steps/operations/04-completion.md` | `history/operations.md` の「PR マージ」記録 |
...
| `operations.release_done` | - | `history/operations.md`（「PR Ready 化」記録の有無で判定。未存在は未着手扱い、blocking ではない） |
| `operations.completion_done` | - | `history/operations.md`（「PR マージ」記録の有無で判定。未存在は未着手扱い、blocking ではない） |
...
| `operations.release_done` | `history/operations.md` | `spec§5.operations.release_done` | `spec§6` | `spec§8` |
| `operations.completion_done` | `history/operations.md` | `spec§5.operations.completion_done` | `spec§6` | `spec§8` |
...
| 3 | progress.md ステップ1-7 すべて「完了」or「スキップ」、history に PR Ready 化記録なし | operations | `operations.03-release` |
| 4 | history に「PR Ready 化」記録あり、PR マージ記録なし | operations | `operations.04-completion` |
...
| 3 | `format_error`（§7.1） | blocking | operations/progress.md 存在するがパース不能 | `phase.result=operations`、`step.result=undecidable:format_error`、ユーザー確認必須 |
