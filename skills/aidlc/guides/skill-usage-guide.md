...
```text
.claude/skills/
├── reviewing-code/           → <MARKETPLACE_ROOT>/skills/reviewing-code/           (シンボリックリンク)
├── reviewing-architecture/   → <MARKETPLACE_ROOT>/skills/reviewing-architecture/   (シンボリックリンク)
├── reviewing-security/       → <MARKETPLACE_ROOT>/skills/reviewing-security/       (シンボリックリンク)
├── reviewing-inception/      → <MARKETPLACE_ROOT>/skills/reviewing-inception/      (シンボリックリンク)
