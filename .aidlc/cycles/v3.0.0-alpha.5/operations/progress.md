...
| 7. リリース準備 | 完了 | README.md, CHANGELOG.md, history.md, PR | 2026-06-27 |
...
<!-- release_prep_commit: 455c49a5fb8cd12136df1a9b1232c127b03b22c1 -->

## 現在のステップ

次回: 7.8 ドラフトPR Ready化以降（PR準備完了 = ステップ7「完了」）

## 完了済みステップ

- 1. 変更確認（変更なしを選択、ステップ2-5をスキップ）
- 6. バックログ整理と運用計画
- 7. リリース準備（7.1-7.6 PR準備完了）

## 次回実行時の指示

PR Ready化（7.8）以降のレビュー・マージ作業から開始してください。
