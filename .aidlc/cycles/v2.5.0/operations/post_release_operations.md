...
- **バージョン**: v2.5.0
- **リリース日**: 2026-04-29（予定）
- **リリース内容**: 自己改善ループ導入（#590 + #592 + #625 コア対応）
  ...
  - Unit 007 (#625 完全対応): 04-completion §1-2 振り返りステップの構造化（KPT + 主因切り分け 3 分類 + 格納先 3 分岐ガイド + write-history.sh ガード整合 + テンプレ 2 個）
...
- #625: Operations Phase 04-completion §1-2 振り返りステップの構造化（B-3+B-4 セット対応）
