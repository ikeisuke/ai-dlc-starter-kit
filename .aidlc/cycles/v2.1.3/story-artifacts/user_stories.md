...
As a AI-DLCを使って開発する開発者
I want to 各フェーズ・Unit完了時に完了サマリが表示される
So that 次のセッションで何が完了したか・何を参照すべきかが即座にわかり、コンテキストリセット後の引き継ぎがスムーズになる

**受け入れ基準**:
- [ ] Inception Phase完了時に、コンテキストリセット提示の前に完了サマリが表示されること
- [ ] Construction Phase Unit完了時に、コンテキストリセット提示の前に完了サマリが表示されること
- [ ] Operations Phase完了時に、コンテキストリセット提示の前に完了サマリが表示されること
- [ ] サマリに成果物一覧・主な決定事項・レビュー結果が含まれること
- [ ] サマリに詳細を確認するための参照ファイルパスが含まれること
