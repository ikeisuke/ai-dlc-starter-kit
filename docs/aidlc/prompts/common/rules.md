...
```bash
docs/aidlc/bin/read-config.sh rules.upgrade_check.enabled
```
...
```bash
docs/aidlc/bin/read-config.sh rules.depth_level.level
```
...
```bash
docs/aidlc/bin/read-config.sh rules.construction.max_retry
```
...
```bash
docs/aidlc/bin/read-config.sh rules.preflight.enabled
```
...
```bash
docs/aidlc/bin/read-config.sh rules.preflight.checks
```
