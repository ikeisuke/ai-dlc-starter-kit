...
**AIレビュー**: 計画承認前に `skills/aidlc/steps/common/review-flow.md` に従ってAIレビューを実施すること。
...
1. **AIレビュー実施**（`skills/aidlc/steps/common/review-flow.md` に従う）
2. レビュー結果を反映
...
2. **AIレビュー実施**（`skills/aidlc/steps/common/review-flow.md` に従う）
3. レビュー結果を反映
...
**【次のアクション】** `skills/aidlc/steps/common/commit-flow.md` の「Squash統合フロー」を読み込んで、手順に従ってください。
...
squashを実行していない場合は、`skills/aidlc/steps/common/commit-flow.md` の「Unit完了コミット」手順に従ってください。
...
- 履歴記録とコミット
- Operations Phaseに戻る: `/aidlc operations` を実行
