...
- **成果物**: `.aidlc/cycles/{{CYCLE}}/design-artifacts/domain-models/[unit_name]_domain_model.md`（テンプレート: `docs/aidlc/templates/domain_model_template.md`）
...
- **成果物**: `.aidlc/cycles/{{CYCLE}}/design-artifacts/logical-designs/[unit_name]_logical_design.md`（テンプレート: `docs/aidlc/templates/logical_design_template.md`）
