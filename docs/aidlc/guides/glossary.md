...
| Depth Level | `depth_level` | 設計・実装の詳細度設定。`minimal` / `standard` / `comprehensive` | 全フェーズ | `prompts/common/rules.md` |
...
| Semi-auto | `semi_auto` | 承認ゲートを自動パスするautomation_mode設定。適用条件と制約は参照先を確認 | 全フェーズ | `prompts/common/rules.md` |
