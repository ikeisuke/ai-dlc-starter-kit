...
- 成果物: `{{VERSIONS_ROOT}}/{{VERSION}}/operations/deployment_checklist.md`
- テンプレート: `{{AIDLC_ROOT}}/templates/deployment_checklist_template.md` を参照
...
- 成果物: `{{VERSIONS_ROOT}}/{{VERSION}}/operations/monitoring_strategy.md`
- テンプレート: `{{AIDLC_ROOT}}/templates/monitoring_strategy_template.md` を参照
...
- レビュー対応、メタデータ準備
- 成果物: `{{VERSIONS_ROOT}}/{{VERSION}}/operations/distribution_feedback.md`（該当する場合のみ）

### 5. リリース後の運用【対話形式】

- 同様に**一問一答形式**で対話
- インシデント対応、バグ修正、ユーザーフィードバック収集
- 成果物: `{{VERSIONS_ROOT}}/{{VERSION}}/operations/post_release_operations.md`
- テンプレート: `{{AIDLC_ROOT}}/templates/post_release_operations_template.md` を参照

## 実行ルール

1. **計画作成**: まず実行計画を `{{VERSIONS_ROOT}}/{{VERSION}}/plans/operations_plan.md` に作成
...
- `{{AIDLC_ROOT}}/prompts/additional-rules.md` → 新バージョンにコピーしてカスタマイズを引き継ぐ
