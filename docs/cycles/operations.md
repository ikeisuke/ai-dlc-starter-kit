...
| 2026-01-26 | v1.9.2 | プレリリースバージョン対応、operations.mdサイズ最適化、KiroCLI対応 |
| 2026-02-20 | v1.16.0 | シェルスクリプトバグ修正、Operations Phaseリモート同期確認ステップ追加 |
| 2026-03-04 | v1.18.3 | PRチェックにBash置換チェック追加、post-merge-sync.sh追加 |
